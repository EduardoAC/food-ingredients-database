...
export type GetFoodsSearchDataTypeItem =
  (typeof GetFoodsSearchDataTypeItem)[keyof typeof GetFoodsSearchDataTypeItem]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetFoodsSearchDataTypeItem = {
  Branded: 'Branded',

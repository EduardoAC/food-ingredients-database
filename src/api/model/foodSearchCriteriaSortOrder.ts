 ...
 */
export type FoodSearchCriteriaSortOrder =
  (typeof FoodSearchCriteriaSortOrder)[keyof typeof FoodSearchCriteriaSortOrder]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const FoodSearchCriteriaSortOrder = {
  asc: 'asc',
  desc: 'desc'
} as const
